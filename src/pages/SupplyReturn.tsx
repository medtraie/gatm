...
const SupplyReturn = () => {
  ...
  const [lastReference, setLastReference] = useStickyState<string>('', 'lastSupplyReference');
  ...
  // الطي/الإظهار مع مزامنة السيرفر
  const [supplyHistoryOpen, setSupplyHistoryOpen] = useStickyState<boolean>(false, "supplyReturn.historyOpen");
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-muted/50 p-4 rounded-lg">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-2xl font-bold text-primary">{calculateNetToPay().toFixed(2)} DH</span>
                      </div>
                    ...
                    {(paymentCashAmount || paymentCheckAmount || paymentMygazAmount) && (
                      <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg">
                        ...
                        <div className="text-sm text-orange-700">
                          Calcul: ({calculatePaymentTotals().total.toFixed(2)}) - ({(parseFloat(paymentCashAmount) || 0).toFixed(2)} + {(parseFloat(paymentCheckAmount) || 0).toFixed(2)} + {(parseFloat(paymentMygazAmount) || 0).toFixed(2)}) = {calculatePaymentDebt().toFixed(2)} DH
                        </div>
